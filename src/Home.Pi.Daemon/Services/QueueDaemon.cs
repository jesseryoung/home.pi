...
internal class QueueDaemon : BackgroundService
{
    private readonly ILogger<QueueDaemon> logger;
    ...
    public QueueDaemon(ILogger<QueueDaemon> logger, QueueClient queueClient, IServiceProvider serviceProvider)
    {
        this.logger = logger;
